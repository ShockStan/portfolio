...
export const gitHub = {
  ...
  thymeleaf:
    'https://github.com/ShockStan/springboot-thymeleaf-posgresql-PBKDF2',
  python:
    'https://github.com/ShockStan/Django-OnlineMarkerPlace-SportsEquipment',
...
export const about = {
  bio1: 'Hi there, I am Arvindh. A full stack web developer who specialises in aNGular, Node, NestJS and Java.',
  bio: 'Dynamic full-stack developer with a proven track record of continuous growth and a strong passion for technology. Seeking new challenges and opportunities to leverage skills and drive innovation in a collaborative team environment.',
  experience1: 'Yes, a 22 year old fresher who graduated college a year back.',
  experience:
    'Currently, working as Full Stack Developer in Cholamandalam Investment and Finance Company Ltd',
  education: {
    course: 'B.Tech, textile technology',
    year: '2022',
    percentage: '83%',
  },
  join: 'My notice period is 30 days',
};
